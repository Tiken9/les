...
_DECOMPOSER = _descriptor.EnumDescriptor(
  name='Decomposer',
...
_sym_db.RegisterEnumDescriptor(_DECOMPOSER)

Decomposer = enum_type_wrapper.EnumTypeWrapper(_DECOMPOSER)
QUASIBLOCK_FINKELSTEIN_DECOMPOSER = 0
MAX_CLIQUE_DECOMPOSER = 1

DECOMPOSER_PARAMETERS_FIELD_NUMBER = 101
decomposer_parameters = _descriptor.FieldDescriptor(
...
_DECOMPOSERPARAMETERS = _descriptor.Descriptor(
...
DESCRIPTOR.enum_types_by_name['Decomposer'] = _DECOMPOSER
DESCRIPTOR.extensions_by_name['decomposer_parameters'] = decomposer_parameters
_sym_db.RegisterFileDescriptor(DESCRIPTOR)

DecomposerParameters = _reflection.GeneratedProtocolMessageType('DecomposerParameters', (_message.Message,), dict(
  DESCRIPTOR = _DECOMPOSERPARAMETERS,
  __module__ = 'les.decomposers.decomposers_pb2'
  # @@protoc_insertion_point(class_scope:les.decomposers.DecomposerParameters)
  ))
_sym_db.RegisterMessage(DecomposerParameters)
